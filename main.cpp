...
void foo()
{
    ...
    std::cout << "Grafo construido\n";

    while (true)
    {
        std::cout << "\nEntre com a origem e o destino do caminho hamiltoniano: ";
