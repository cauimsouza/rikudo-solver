...
private:
    ...
    std::vector<std::vector<int>>& hamiltonian_path_sat(int source, int last, bool count);

    std::vector<std::vector<int>>& hamiltonian_cycle_sat(bool count);

    std::vector<std::vector<int>>& hamiltonian_path_bt(int source, int last, bool count=false);
...
public:
    ...
    std::vector<std::vector<int>>& hamiltonian_path(int source, int last, bool sat, bool count);
